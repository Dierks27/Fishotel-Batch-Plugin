...
trait FisHotel_Ajax {
    ...
    public function ajax_save_scene_types() {
        ...
        // Scene types are now derived from the Categories tab — this endpoint is deprecated.
        wp_send_json_error( [ 'message' => 'Scene types are now managed via the Categories tab.' ] );
    }
