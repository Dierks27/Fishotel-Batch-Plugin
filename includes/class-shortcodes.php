    ...
    public function render_last_call_page( $batch_name ) {
        ...
        <div class="fhlc-wrap">
            ...
            <?php if ( $has_results ) : ?>
                ...
                .fhlc-deal-card.fhlc-mine .fhlc-card-front::after{content:'★ YOURS';position:absolute;top:0px;right:-22px;background:linear-gradient(135deg,#1a3a6b,#0f2448);color:rgba(255,255,255,0.9);font-family:'Oswald',sans-serif;font-size:clamp(6px,1vw,10px);font-weight:700;letter-spacing:0.1em;padding:2px 28px;transform:rotate(45deg);z-index:5;box-shadow:0 1px 4px rgba(0,0,0,0.4);}
                ...
                .fhlc-card-front{transform:rotateY(180deg);background-color:#faf8f2;background-size:100% 100%;background-repeat:no-repeat;box-shadow:0 6px 24px rgba(0,0,0,0.5);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:17% 16% 14%;text-align:center;}
                .fhlc-card-front .fhlc-cf-round{font-family:'Courier New',monospace;font-size:clamp(8px,1.2vw,12px);color:#888;text-transform:uppercase;letter-spacing:0.1em;margin-bottom:2%;text-align:center;}
                .fhlc-card-front .fhlc-cf-fish{font-family:'Tulpen One','Oswald',sans-serif;font-size:clamp(14px,2.6vw,28px);font-weight:700;color:#1a1a1a;margin:3% 0;line-height:1.1;width:100%;overflow:hidden;word-break:break-word;text-transform:uppercase;}
                .fhlc-card-front .fhlc-cf-customer{font-family:'Special Elite',cursive;font-size:clamp(8px,1.2vw,12px);color:#96885f;width:100%;overflow:hidden;word-break:break-word;margin-top:auto;margin-bottom:1%;}
                .fhlc-card-front .fhlc-cf-qty{font-family:'Courier New',monospace;font-size:clamp(9px,1.3vw,12px);color:#666;margin-top:0;}
                .fhlc-card-front .fhlc-cf-suit{position:absolute;top:3.4%;left:3.2%;font-size:clamp(14px,2.2vw,22px);}
                .fhlc-card-front .fhlc-cf-suit-br{position:absolute;bottom:5.5%;right:5%;font-size:clamp(14px,2.2vw,22px);transform:rotate(180deg);}
