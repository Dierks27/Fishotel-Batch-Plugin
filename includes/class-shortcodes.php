...
trait FisHotel_Shortcodes {
    ...
    public function render_last_call_page( $batch_name ) {
        ...
        $fonts_url = 'https://fonts.googleapis.com/css2?family=Oswald:wght@400;600;700&family=Special+Elite&family=Klee+One&family=Righteous&family=Dancing+Script:wght@600&family=Tulpen+One&family=Fredericka+the+Great&family=Pompiere&display=swap';
        ...
        <div class="fhlc-wrap">
            ...
            <?php if ( $has_results ) : ?>
                ...
                .fhlc-card-front .fhlc-cf-fish{font-family:'Pompiere','Tulpen One',cursive;font-size:clamp(12px,1.8vw,20px);font-weight:400;color:#1a1a1a;margin:4% 0;line-height:1.15;width:100%;overflow:hidden;word-break:break-word;text-transform:uppercase;}
